        ...
        <ul class="list-unstyled">
          <li class="cursor-pointer mb-1">
            <feather-icon
              ...
              class="mr-75"
            />
            <span class="align-middle">{{ $t('Add Tag') }}</span>
          </li>
          <li class="cursor-pointer mb-1">
            <feather-icon
              icon="StarIcon"
              ...
              class="mr-75"
            />
            <span class="align-middle">{{ $t('Important Contact') }}</span>
          </li>
          <li class="cursor-pointer mb-1">
            <feather-icon
              icon="ImageIcon"
              ...
              class="mr-75"
            />
            <span class="align-middle">{{ $t('Shared Media') }}</span>
          </li>
          <li class="cursor-pointer mb-1">
            <feather-icon
              icon="TrashIcon"
              ...
              class="mr-75"
            />
            <span class="align-middle">{{ $t('Delete Contact') }}</span>
          </li>
          <li class="cursor-pointer">
            <feather-icon
              ...
              class="mr-75"
            />
            <span class="align-middle">{{ $t('Block Contact') }}</span>
          </li>
        </ul>
      </div>
    </vue-perfect-scrollbar>

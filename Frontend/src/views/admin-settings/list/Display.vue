    ...
    >
      ...
      >
        ...
        <template #cell(title)="data">
          <b-link
            :to="{ name: 'admin-settings', params: { id: data.item.id } }"
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item :to="{ name: 'admin-settings', params: { id: data.item.id } }">
            ...
            >
              ...
              <span class="align-middle ml-50">Kopie erstellen</span>
            </b-dropdown-item>
          </b-dropdown>
        </template>
      </b-table>
...
export default {
  ...
  setup(_, ctx) {
    ...
    console.log(ctx)
    const createCopy = id => {
      store.dispatch(`${STORE_MODULE_NAME}/copySetting`, { id })
        .then(response => {
          console.log(response)
          if (response.data.status === 200) {
            ctx.root.$router.push({ name: 'admin-settings', params: { id: response.data.message } })
            //  refetchData()
          }
        })
        .catch(error => {

    ...
    <template #default="{ hide }">
      ...
      >
        ...
        >
          ...
          <b-form-group
            label="Power Production (MWp)"
            label-for="powerProductionForecast"
          >
            <b-form-input
              id="powerProductionForecast"
              v-model="postData.powerProductionForecast"
              autofocus
              trim
              placeholder="Enter Power Production"
            />
          </b-form-group>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const onSubmit = () => {
      ...
      store.dispatch(`${STORE_MODULE_NAME}/addItem`, postData.value)
        .then(response => {

...
class DemoDataSeeder extends Seeder
{
    ...
    protected function createSolarPlants(User $owner, User $manager): array
    {
        ...
        $plants[] = SolarPlant::create([
            ...
            'country' => 'Deutschland',
            'nominal_power' => 150.0,
            'expected_annual_production' => 150000,
            'annual_consumption' => 120000,
            'installation_date' => Carbon::now()->subMonths(6),
            'commissioning_date' => Carbon::now()->subMonths(5),
            'total_cost' => 180000,
        ...
        $plants[] = SolarPlant::create([
            ...
            'country' => 'Deutschland',
            'nominal_power' => 200.0,
            'expected_annual_production' => 200000,
            'annual_consumption' => 150000,
        ...
        $plants[] = SolarPlant::create([
            ...
            'country' => 'Deutschland',
            'nominal_power' => 100.0,
            'expected_annual_production' => 110000,
            'annual_consumption' => 80000,
            'total_cost' => 120000,
        ...
        $plants[] = SolarPlant::create([
            ...
            'country' => 'Deutschland',
            'nominal_power' => 175.0,
            'expected_annual_production' => 170000,
            'annual_consumption' => 140000,
            'total_cost' => 210000,
